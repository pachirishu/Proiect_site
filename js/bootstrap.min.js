if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    function e(e, i) {
        ...
        if (-1 !== t.inArray(n, i)) return -1 !== t.inArray(n, s) ? Boolean(e.nodeValue.match(l) || e.nodeValue.match(p)) : !0;
        for (var o = t(i).filter(function(t, e) {
    ...
    function i(i, n, o) {
        ...
        for (var r = t.map(n, function(t, e) {
                return e
            }), a = t(s.body).find("*"), l = 0, p = a.length; p > l; l++) {
            var h = a[l],
                f = h.nodeName.toLowerCase();
            if (-1 !== t.inArray(f, r))
                for (var c = t.map(h.attributes, function(t) {
                        return t
                    }), d = [].concat(n["*"] || [], n[f] || []), u = 0, g = c.length; g > u; u++) e(c[u], d) || h.removeAttribute(c[u].nodeName);
    ...
    function n(e) {
        return this.each(function() {
            var i = t(this),
                n = i.data("bs.tooltip"),
                o = "object" == typeof e && e;
            !n && /destroy|hide/.test(e) || (n || i.data("bs.tooltip", n = new h(this, o)), "string" == typeof e && n[e]())
        })
    }
    ...
    h.VERSION = "3.4.1", h.TRANSITION_DURATION = 150, h.DEFAULTS = {
        ...
        sanitizeFn: null,
        whiteList: a
    }, h.prototype.init = function(e, i, n) {
        ...
        for (var s in n) n.hasOwnProperty(s) && -1 !== t.inArray(s, o) && delete n[s];
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                r = "bottom" == r && p.bottom + c > u.bottom ? "top" : "top" == r && p.top - c < u.top ? "bottom" : "right" == r && p.right + f > u.width ? "left" : "left" == r && p.left - f < u.left ? "right" : r, o.removeClass(d).addClass(r)
            }
            var g = this.getCalculatedOffset(r, p, f, c);
            this.applyPlacement(g, r);
            var v = function() {
                var t = n.hoverState;
                n.$element.trigger("shown.bs." + n.type), n.hoverState = null, "out" == t && n.leave(n)
            };
            t.support.transition && this.$tip.hasClass("fade") ? o.one("bsTransitionEnd", v).emulateTransitionEnd(h.TRANSITION_DURATION) : v()
        }
        ...
        var f = /top|bottom/.test(i),
            c = f ? 2 * h.left - o + l : 2 * h.top - s + p,
            d = f ? "offsetWidth" : "offsetHeight";
        n.offset(e), this.replaceArrow(c, n[0][d], f)
        ...
        return this.$element.trigger(s), s.isDefaultPrevented() ? void 0 : (o.removeClass("in"), t.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", i).emulateTransitionEnd(h.TRANSITION_DURATION) : i(), this.hoverState = null, this)
        ...
        if (/right|left/.test(t)) {
            ...
            var p = e.left - s,
                h = e.left + s + i;
            p < r.left ? o.left = r.left - p : h > r.right && (o.left = r.left + r.width - h)
        }
        return o
    ...
    var f = t.fn.tooltip;
    t.fn.tooltip = n, t.fn.tooltip.Constructor = h, t.fn.tooltip.noConflict = function() {
    ...
    var i = function(e, n) {
        ...
        var o = this.options.target === i.DEFAULTS.target ? t(this.options.target) : t(document).find(this.options.target);
    ...
    i.VERSION = "3.4.1", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        var a = null == this.affixed,
            l = a ? o : s.top,
            p = a ? r : e;
        return null != i && i >= o ? "top" : null != n && l + p >= t - n ? "bottom" : !1
